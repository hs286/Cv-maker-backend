...
import { UserService } from "../user/service/user.service"; // Import Swagger decorators
...
export class NotificationService {
     ...
     */
    @ApiOkResponse({
        description: "Successfully acknowledged notification",
    ...
    async acknowledgeNotification(
        ...
        try {
            ...
            throw new BadRequestException({
                status: API_STATUS.FAILURE,
                message:
                    "Failed to acknowledge notification. Internal server error.",
            });
        }
    }
    ...
    async createNotification(
        ...
        try {
            ...
            if (!conversation) {
                throw new NotFoundException(
                    `Conversation not found for ticketId: ${ticketId}`,
                );
            }
            ...
            throw new BadRequestException({
                status: API_STATUS.FAILURE,
                message:
                    "Failed to create notification. Internal server error.",
            });
        }
    }
     ...
     */
    @ApiOkResponse({
        description: "Successfully dismissed notification",
        type: ApiResponse<Notification>,
    })
    @ApiBadRequestResponse({
        description: "Notification not found.",
    ...
    async dismissNotification(
        ...
        try {
            ...
            throw new BadRequestException({
                status: API_STATUS.FAILURE,
                message:
                    "Failed to dismiss notification. Internal server error.",
            });
        }
    }
    ...
    async getNotificationsForUser(
        ...
        try {
            ...
            throw new BadRequestException({
                status: API_STATUS.FAILURE,
                message:
                    "Failed to retrieve notifications. Internal server error.",
            });
        }
    }
}
